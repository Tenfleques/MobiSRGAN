...
# Model checkpoints
srgan_checkpoint = "/Volumes/GoogleDrive/My Drive/weights/srgan/checkpoint_srgan.pth.tar"
srresnet_checkpoint = "/Volumes/GoogleDrive/My Drive/weights/srgan/checkpoint_srresnet.pth.tar"
...
if __name__ == '__main__':
    grid_img = visualize_sr("../data/set14/img_001_SRF_2_LR.png")
