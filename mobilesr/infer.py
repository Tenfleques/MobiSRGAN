...
def_output = os.path.join(self_dir, "../", "data/DIV2K/sr/mobisrgan/{}".format(device))
...
parser.add_argument('--weights', type=str, help='Directory where to weights file', default=os.path.join(self_dir, "../weights/mobisrgantf/generator.h5"))
...
def infer_ctrl(**kwargs):
    ...
    model = keras.models.load_model(kwargs.get("weights", os.path.join(self_dir, "../weights/mobilesrgan/generator.h5")))
